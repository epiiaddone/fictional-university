      ...
      <div class="container">
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            <ul>
              <li <?php if(is_page('about-us') || wp_get_post_parent_id(0)==44) echo "class='current-menu-item'" ?>><a href="<?php echo esc_url(site_url('/about-us'))?>">About Us</a></li>
              <li <?php if(get_post_type() == 'program' OR is_page('past-programs')) echo "class='current-menu-item'"?>><a href="<?php echo get_post_type_archive_link('program');?>">Programs</a></li>
          ...
          <div class="site-header__util">
            ...
            <span class="site-header__avatar"><? echo get_avatar(get_current_user_id(), 60); ?></span> 
